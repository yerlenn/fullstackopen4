...
describe('most likes', () => {
    ...
    test('when list has only one blog returns that blog', () => {
        assert.deepStrictEqual(favouriteBlog(listWithOneBlog), listWithOneBlog[0])
    })
    ...
    test('of a list with two blogs of equal likes returns only one of them', () => {
        assert.deepStrictEqual(favouriteBlog(listWithTwoBlogs), 
            {
                _id: "5a422a851b54a676234d17f7",
                title: "React patterns",
                author: "Michael Chan",
